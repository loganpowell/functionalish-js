 ...
 */
export declare type Conditional = string | IObjectOf<boolean | number | string>;
/**
 * Format
 */
...
export declare const DEFAULT_VENDORS: string[];
/**
 ...
 */
export declare const COMPACT: Format;
/**
 * Pretty printing format config with line breaks
 * and indentation.
 */
export declare const PRETTY: Format;
