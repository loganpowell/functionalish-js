 ...
 */
export declare const groupBinary: <T>(bits: number, key: Fn<T, number>, branch?: Fn0<IObjectOf<T[]>> | undefined, leaf?: Reducer<any, T> | undefined, left?: string | number | symbol, right?: string | number | symbol) => Reducer<any, T>;
